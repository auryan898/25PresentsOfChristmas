...
function update ()
{
    ...
    if (mover.isActive) {
        ...
        graphics.fillRect(startX, startY, 160, 160);
        graphics.fillRect(bounds(mover.pointer.x, startX-80, startX+80), bounds(mover.pointer.y, startY-80, startY+80), 80, 80);
    }

    if (jumper.isActive) {
        graphics.fillStyle(0x0000ff, 1);
        graphics.fillRect(jumper.startX, jumper.startY, 80, 80);
    }
}
